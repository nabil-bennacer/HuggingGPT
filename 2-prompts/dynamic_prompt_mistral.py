...
from mistral import llm_mistral
...
response1 = llm_mistral.chat.complete(model=model, messages=[{"role": "user", "content": prompt1}])
response2 = llm_mistral.chat.complete(model=model, messages=[{"role": "user", "content": prompt2}])
